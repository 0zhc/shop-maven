...
<iframe src="<%=path %>/shop/prolist.do?template=${param.template }&userId=${param.userId}&shopId=${param.shopId}"
        width="942" marginwidth="0" marginheight="0" frameborder="0" scrolling="no" name="mainRight" id="mainRight"
        onLoad="iFrameHeight()"></iframe>
<div id="loader_container" style="text-align: center; position: absolute; left: 300px; top: 100px;"><img
        src="<%=path %>/system/shop/myshop/loading.gif"/></div>
</body>
</html>
