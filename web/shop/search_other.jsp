        ...
        function query(i) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    'userId': userId,
                    'goodsType': goodsType,
                    'proKeyWord': proKeyWord,
                    'oneProPrice': oneProPrice,
                    'twoProPrice': twoProPrice
                },
...
<div id="search_prolist">
    <div id="search_condition">
        <div id="search_condition_title">
            <div id="condition_title_letter"><%=java.net.URLDecoder.decode(request.getParameter("otherText").toString(), "UTF-8")%>
            </div>
        </div>
        <div id="search_condition_main">
            <span id="pro_quantity">共搜索到<span id="totalRecord"></span>个<span
                    style="color:color:#e90000;"><%=java.net.URLDecoder.decode(request.getParameter("otherText").toString(), "UTF-8")%></span>。</span>
            <span id="search_price">关键字：<input type="text" maxlength="40" id="keyWord"/>&nbsp;&nbsp;价格：<input
                    type="text" maxlength="10" id="price1"/>&nbsp;到&nbsp;<input type="text" maxlength="10" id="price2"/></span>
