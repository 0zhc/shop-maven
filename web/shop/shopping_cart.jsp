                        ...
                        <c:forEach items="${cartOrder}" var="cartOrder" varStatus="status">
                            <tr class="table_middle">
                                ...
                                <td align="center">${cartOrder.good.price }元
                                    <input type="hidden" id="price${status.count }" name="price${status.count }"
                                           value="${cartOrder.good.price }"/>
                                </td>
                                    <%--购买数量--%>
                                <td align="center">
                                ...
                                <td align="center">${cartOrder.good.amount }
                                    ...
                                    <%--总金额--%>
                                <td align="center">
                                    <span id="total${status.count }"
                                          value="${cartOrder.total }">${cartOrder.total }</span>
