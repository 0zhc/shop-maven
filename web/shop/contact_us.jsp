...
<div id="Contactcontianer" style="height:800px; width:914px; position:relative; overflow:hidden;">
    <a href="javascript:void(0)" title="Contact" onclick="ShowCantact()" class="modifytip"
       style="display:none;  position:absolute; left:730px; top:10px;">修改</a>
    <div id="Contacttip"><span style="margin-left:20px;">联系我们</span></div>

    <div id="Contactmain"
         style=" background-image:url(<%=request.getContextPath()%>/shop/shop_image/goodsdescripTipmiddle.jpg);width:895px; background-size: 922px;  background-repeat:repeat-y; padding-left:10px; padding-right:10px; padding-bottom:20px;">
        ${shop.contactUs}
    </div>

    <div id="Contactbottom"
         style="background-image:url(<%=request.getContextPath()%>/shop/shop_image/goodsdescripTipbottom.jpg); background-repeat:no-repeat; background-size: 922px; width:915px; height:19px;"></div>
</div>
