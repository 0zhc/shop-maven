...
<center>
    <div id="content" style=" width:550px;">
        <fieldset>
            ...
            <form action="<%=request.getContextPath() %>/order/confirmOrder.do" class="registerform" name="orderForm"
                  method="post">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td align="left"><input type="text" name="amount" id="amount" class="inputxt" value="${amount }"
                                                onBlur="check()"/><span style="color:red;">*</span>(库存量有${good.amount }件)
                    ...
                    <tr>
                        ...
                        <td align="left"><input type="text" name="receiverName" id="receiverName" onBlur="checkName()"
                                                datatype="*2-5" errormsg="请输入您的名字！"/><span style="color:red;">*</span>(中文名)
                        </td>
                    </tr>
                    <tr>
                        <td align="right">手机电话：</td>
                        <td align="left"><input type="text" name="phone" id="phone" style="width:150px" datatype="m"
                                                errormsg="请输入您的手机号码！"/><span style="color:red;">*</span></td>
                    </tr>
                    <tr>
                        <td align="right">短号：</td>
                        <td align="left"><input type="text" name="shortPhone" id="shortPhone" style="width:150px"
                                                datatype="n" ignore="ignore" errormsg="请输入您的短号！"
                                                onBlur="checkshortPhone()"/></td>
                    </tr>
                    <tr>
                        <td align="right">送货地址：</td>
                        <td align="left"><input type="text" name="address" id="address" style="width:220px"
                                                onBlur="checkAddress()" datatype="*1-30" errormsg="请输入送货地址！"/><span
                                style="color:red;">*</span>(限制30个字符)
                        </td>
                    </tr>
                    <tr>
