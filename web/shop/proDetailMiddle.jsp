...
<iframe src="<%=path %>/shop/pro_detail.do?goodsId=${param.goodsId }&template=${param.template}" width="942"
        marginwidth="0" marginheight="0" frameborder="0" scrolling="no" name="mainRight" id="mainRight"
