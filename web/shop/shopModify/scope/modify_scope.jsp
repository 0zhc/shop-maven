...
<div id="container">
    <center>
        <div>
            <form action="<%=request.getContextPath()%>/modifyShopScope.do?userId=${userId}" id="myForm" method="post"
                  onsubmit="return validatTextarea()">
                <fieldset>
                    <legend>配送范围</legend>
                    <div id="if_add">您还没有添加商家介绍信息！<a href="javascript:void(0)" id="add">马上添加</a></div>
                    <div id="ScopeContent"><textarea name="content" cols="21" rows="10" id="content1"
                                                     style="width:100%">${shop.deliverScope}</textarea>
