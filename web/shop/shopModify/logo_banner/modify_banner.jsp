...
<head>
    ...
    <script type="text/javascript">
        ...
        function ajaxFileUpload() {
            ...
            $.ajaxFileUpload(
                {
                    url: '<%=path %>/shop/uploadFileModifyBnnaer.do?x1=' + x1 + '&y1=' + y1 + '&w=' + w + '&h=' + h + '&userName=' + userName + '&shopId=' + shopId + '&goodsType=' + goodsType + '&goodsId=' + goodsId + "&bannerUrl=" + bannerUrl,            //需要链接到服务器地址
                    secureuri: false,
                    type: "post",
    ...
    <script type="text/javascript">
        ...
        function clacImgZoomParam(maxWidth, maxHeight, width, height) {
            var param = {width: 890, height: 88, top: 0, left: 0};
...
<div id="content" style="padding-left: 30px;padding-top: 3px; width: 1050px;">
    ...
    <table class="myshop" cellspacing="0" style="width: 100%;">
        <tr>
            <th colspan="5">店铺<span>>></span>店铺装修<span>>></span>修改滚动商品</th>
        ...
        <tr>
            ...
            <td colspan="4" style="height: 100px;padding-left: 20px;">
                <img src="<%=path %>/${shop.bannerUrl}" height="88px" width="890px;"/>
                ...
                <div id="add">
                    ...
                    <div id="preview_fake" style="width:890px; height:88px; background-color: #ccc;">
                        <img id="preview" src="<%=path %>/cutpicture/imgs/show.gif" onload="onPreviewLoad(this)"/>
                        <!-- firefox -->

                    </div>
                    <div>(<span style="color: red; font-size: 12px;">注</span>:长度890px和高度为88px，大小不要超过200KB，只能使用gif,jpg格式)
                    </div>
                    ...
                    <input type="button" value="修改图片" onclick="ajaxFileUpload(add)"
                           style="width: 60px; margin-left: 50px;"/><img src="<%=path %>/cutpicture/imgs/loading.gif"
                                                                         id="loading"
        ...
        <tr>
            <td colspan="5" style="text-align: center;"><a href="<%=path %>/system/shop/prompt.do?Jsptype=decalareShop"
                                                           style="color: blue;">返回查询页面</a></td>
        </tr>
