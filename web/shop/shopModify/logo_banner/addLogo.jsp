...
<head>
    ...
    <script type="text/javascript">
        ...
        function ajaxFileUpload() {
            ...
            $.ajaxFileUpload(
                {
                    url: '<%=path %>/fileupload/addLogo.do?x1=' + x1 + '&y1=' + y1 + '&w=' + w + '&h=' + h + '&userName=' + userName + '&shopId=' + shopId + '&goodsType=' + goodsType,            //需要链接到服务器地址
                    secureuri: false,
                    type: "post",
...
<body>
<div id="content" style="padding-left: 230px;padding-top: 3px; width: 780px;">
    <form action="<%=path %>/system/modifyUserGoods.do" method="post" id="addOtherForm" onsubmit="return  isModify();">
        ...
        <table class="myshop" cellspacing="0" style="100%px;">
            <tr>
                <th colspan="5">店铺<span>>></span>店铺装修<span>>></span>添加logo商品</th>
            ...
            <tr>
                ...
                <td colspan="4" style="height: 270px;padding-left: 20px;">
                    ...
                    <div id="add">
                        ...
                        <div>(<span style="color: red; font-size: 12px;">注</span>:宽为132px,高为88px,大小不要超过200KB,只能使用gif,jpg格式)
                        </div>
                        <div id="mypic" style="position:absolute;left: 600px; top:50px;"></div>
                        ...
                        <input type="button" value="上传图片" onclick="ajaxFileUpload(add)"
                               style="width: 60px; margin-left: 50px;" id="uplaodbuttom"/><img
            ...
            <tr>
                <td colspan="5" style="text-align: center;"><a
                        href="<%=path %>/system/shop/prompt.do?Jsptype=decalareShop" style="color: blue;">返回查询页面</a>
                </td>
            </tr>
        </table>
    </form>
