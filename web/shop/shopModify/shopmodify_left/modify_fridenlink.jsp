...
<head>
    ...
    <style type="text/css">
        * {
        ...
        #modifyLinkSuccess, #addFriendLinkSuccess {
            height: 30px;
            margin-top: 12px;
            margin-left: 40px;
            font-family: 宋体;
...
<div id="modify_link">
    <form action="" method="post" id="regForm">
        <fieldset>
            <legend>友情链接</legend>
            <div id="if_add"><span>你还没有添加最新动态信息&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><a id="add" href="#">马上添加</a>
            </div>
            <div id="addComplete">
                <div>
                    <label>1、友情链接网站名称：<span style="color: red;">*</span></label>
                    <input class="new" id="oneLinkNameId" type="text" maxlength="35" name="oneLinkName"
                           value="${friendlinkList[0].urlText}" onBlur="validateoneLinkName()"/>&nbsp;<span
                        class="link_name">不能为空、只能用中文、英文、数字、4-30个字符</span><span id="oneLinkNameSpan"></span>
                </div>
                <div>
                    <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;网站网址：<span
                            style="color: red;">*</span></label>
                    <input class="new_ul" id="oneLinkUrlId" type="text" maxlength="60" name="oneLinkUrl"
                           value="http://${fn:substringAfter(friendlinkList[0].url,'http://')}"
                           onBlur="validateoneLinkUrl()"/>&nbsp;<span class="link_url">第一条友情链接网址不能为空</span><span
                        id="oneLinkUrlSpan"></span>
                </div>
                <div>
                    <label>2、友情链接网站名称：&nbsp;</label>
                    <input class="new" id="twoLinkNameId" type="text" maxlength="35" name="twoLinkName"
                           value="${friendlinkList[1].urlText}" onBlur="validatetwoLinkName()"/>&nbsp;<span
                        class="link_name">只能用中文、英文、数字、4-30个字符</span><span id="twoLinkNameSpan"></span>
                </div>
                <div>
                    <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;网站网址：</label>
                    <input class="new_ul" id="twoLinkUrlId" type="text" maxlength="60" name="twoLinkUrl"
                           value="http://${fn:substringAfter(friendlinkList[1].url,'http://')}"
                           onBlur="validatetwoLinkUrl()"/>&nbsp;<span class="link_url">请输入正确的网址</span><span
                        id="twoLinkUrlSpan"></span>
                </div>
                <div>
                    <label>3、友情链接网站名称：&nbsp;</label>
                    <input class="new" id="threeLinkNameId" type="text" maxlength="35" name="threeLinkName"
                           value="${friendlinkList[2].urlText}" onBlur="validatethreeLinkName()"/>&nbsp;<span
                        class="link_name">只能用中文、英文、数字、4-30个字符</span><span id="threeLinkNameSpan"></span>
                </div>
                <div>
                    <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;网站网址：</label>
                    <input class="new_ul" id="threeLinkUrlId" type="text" maxlength="60" name="threeLinkUrl"
                           value="http://${fn:substringAfter(friendlinkList[2].url,'http://')}"
                           onBlur="validatethreeLinkUrl()"/>&nbsp;<span class="link_url">请输入正确的网址</span><span
                        id="threeLinkUrlSpan"></span>
                </div>
                <div>
