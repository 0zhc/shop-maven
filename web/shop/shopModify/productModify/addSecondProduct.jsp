...
<head>
    ...
    <script type="text/javascript">
        ...
        function ajaxFileUpload() {
            ...
            $.ajaxFileUpload(
                {
                    url: '<%=path%>/shop/user/addPicture.do?goodsIsNew=2&x1=' + x1 + '&y1=' + y1 + '&w=' + w + '&h=' + h + '&userName=' + userName + '&shopId=' + shopId + '&goodsType=' + goodsType + '&TOKEN=' + TOKEN + "&date=" + escape(new Date()),            //需要链接到服务器地址
                    secureuri: false,
                    type: "post",
...
<div id="content" style="width:950px;margin-left: 25px; margin-right: 27px;">
    <form action="<%=path %>/system/modifyUserGoods.do" method="post" id="addOtherForm" onSubmit="return  isModify();">
        <input name="jspType" value="secondAdd" type="hidden">
        <table class="myshop" cellspacing="0" style="100%px;">
            <tr>
                <th colspan="5">店铺<span>>></span>店铺装修<span>>></span>添加最新商品</th>

            </tr>
            <tr>
                <td style="">商品名称：</td>
                <td><input type="text" id="name" name="name" onBlur="checkName()" style="width: 130px;"/><span
            ...
            <tr>
                ...
                <td>
                    商品价格：<input type="text" id="price" name="price" onBlur="checkPrice()"/><span
                        style="color: red;">*</span><span>单位为元</span>

                </td>
                <td>
                    商品尺寸：<input type="text" id="size" name="size" onBlur="checkSize()"/><br/><span>尺寸单位：<input
                        type="text" id="SizeUnit" name="sizeUnit" onBlur="checkSizeUnit()"/></span>&nbsp;
                </td>
                <td>商品数量：
                    <input type="text" id="amount" name="amount" onBlur="checkAmount()"/>
                    <span style="color: red;">*</span><br/><span>数量单位：
                      <input onBlur="checkAmountUnit()" type="text" id="amountUnit"
                             name="amountUnit"/></span>&nbsp;<span style="color: red;">*</span></td>
                <td> 商品产地：<input type="text" id="origin" name="origin" onBlur="checkOrigin()"/>&nbsp;</br></td>

            </tr>
            <tr>
                <td>商品毛重：<input type="text" id="weight" name="weight" onBlur="checkWeight()"/><br/><span>毛重单位：<input
                        type="text" id="grossUnit" name="grossUnit" onBlur="checkGrossUnit()"/></td>
