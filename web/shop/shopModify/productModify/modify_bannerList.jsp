...
<head>
    ...
    <script type="text/javascript">
        ...
        function ajaxFileUpload() {
            ...
            $.ajaxFileUpload(
                {
                    url: '<%=path %>/shop/modifyHotGoods.do?isRolling=1&x1=' + x1 + '&y1=' + y1 + '&w=' + w + '&h=' + h + '&userName=' + userName + '&shopId=' + shopId + '&goodsType=' + goodsType + '&goodsId=' + goodsId,            //需要链接到服务器地址
                    secureuri: false,
                    type: "post",
...
<body>
<div id="content" style="width:995px;margin-left: 15px;">
    ...
    <table class="myshop" cellspacing="0" style="width: 100%;">
        ...
        <tr>
            <td style="padding-left: 10px;font-size: 16px;font-weight: 800;">商品图片</td>
            <td colspan="4" style="height: 270px;padding-left: 20px;">
                ...
                <div id="add">
                    ...
                    <div style="color: purple;margin-top: 15px;font-size: 14px;margin-bottom: 15px;">(<span
                            style="color: red; font-size: 15px;">注</span>:长度777px和高度234px,大小不要超过200KB,只能使用gif,jpg格式)
                    </div>
                    <div id="mypic" style="position:absolute;left: 530px; top:120px;"></div>
        ...
        <tr style="text-align: center;">
            <td colspan="5">
                <div style="text-align: right;"><input type="button" value="取消" onclick="history.back()"
                                                       style="margin-right: 130px;"/></div>
            </td>
        </tr>
