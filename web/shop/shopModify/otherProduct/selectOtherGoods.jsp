...
<div id="content" id="content" style="height:1000px; width:950px;margin-left: 25px; margin-right: 25px;">
    <fieldset>
        ...
        <div style="text-align: right;padding-right: 30px; font-size: 13px;"><span id="tip"
                                                                                   style="margin-right: 100px;"></span><span>设置标题：</span><input
                type="text" name="otherText" id="otherText" style="width: 150px;"/><input type="button" value="修改"
        ...
        <form action="<%=path%>/system/selectUserGoodsByPage.do?">
            ...
            <table width="100%" border="0" cellspacing="0" class="myshop">
                ...
                <tr>
                    <td style="text-align:center; font-size:15px; height:30px;" colspan="6">商品关键字： <input type="text"
                                                                                                          name="name"/>
                    ...
                    <c:when test="${! empty goodses }">
                        <c:forEach items="${goodses}" var="goods">
                            ...
                            <tr>
                                ...
                                <td style="text-align:center; font-size:15px;">
                                    <a href="<%=path %>/system/shop/myshop/goodsDetail.do?JspType=otherDatail&goodsId=${goods.id}">详情</a>
                                    <a href="<%=path %>/system/shop/myshop/goodsDetail.do?JspType=otherModifyDatail&goodsId=${goods.id}">&nbsp;&nbsp;修改&nbsp;&nbsp;&nbsp;&nbsp;</a><a
                                        href="<%=path %>/shop/otherGoods/delete.do?goodsId=${goods.id}&userId=${user.id}&userName=${user.userName}&shopId=${user.shop.id}&name=${name}">删除</a>
                                </td>
                        ...
                        <tr align="center">
                            <td colspan="7">总共有
                                ...
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <a
                                                href="<%=request.getContextPath()%>/system/selectUserGoodsByPage.do?jspType=otherGoods&currentpage=1&goodsType=${goodsType}&name=${name}">&nbsp;&nbsp;
                                            首页</a>
                                    </c:otherwise>
                                </c:choose>
                ...
                <tr>
                    <td colspan="6" style="text-align: center;font-size: 16px;"><a
                            href="<%=path %>/shop/shopModify/otherProduct/add_otherProduct.jsp" style="color: blue;">--->>我要添加</a>
                    </td>
                </tr>
                <tr>
