    ...
    <form action="#">
        <table class="myshop" style="width: 100%;">
            <tr style="background-image:url(../images/sysytem/tableTip.jpg); background-repeat:no-repeat; line-height:21px;">
                <th colspan="2">首页<span>>></span>店铺装修<span>>></span>其他设置>>查看商品详细信息
                </td>
            ...
            <tr>
                <td width="75" style="padding-left:10px; padding-right:10px;">商品名称</td>
                <td>${goods.name}&nbsp;</td>
            ...
            <tr>
                <td width="75" style=" padding-left:10px; padding-right:10px;">商品地址</td>
                <td><%=basePath %>${goods.url}</td>
            </tr>
            ...
            <tr>
                <td width="75" style=" padding-left:10px; padding-right:10px;">商品描述</td>
                <td>${goods.description}&nbsp;</td>

            </tr>
            <tr>
                <td width="75" style=" padding-left:10px; padding-right:10px;">商品图片</td>
                <td><img src="<%=path %>/${goods.url}" width="369px" height="246px"/></td>
            </tr>
