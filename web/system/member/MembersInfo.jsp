    ...
    <form action="<%=path %>/system/findAllUsersByPage.do" method="post">
        <table class="myshop">
            <tr style="background-image:url(../images/sysytem/tableTip.jpg); background-repeat:no-repeat; line-height:21px;">
                <td colspan="5"><a href="#">首页</a><span>>></span><a href="#">后台管理</a><span>>></span><a
                        href="#">会员信息管理</a></td>
            </tr>
            <tr>
                <td style="text-align:center; font-size:15px; height:30px;" colspan="5">
                    用户名：<input type="text" name="userName"/>&nbsp;&nbsp;
                    注册时间：<input type="text" name="beginDate" readonly="readonly" style="width: 80px;"
                                onClick="WdatePicker()"/>&nbsp;——&nbsp;
                    ...
                    <c:forEach items="${users}" var="user">
                        ...
                        <tr>
                            ...
                            <td style="text-align:center;"><a
                                    href="<%=path %>/system/detail/MemberManageDetail.do?id=${user.id }"
                                    target="mainContent">详细</a>&nbsp;&nbsp;<a
                                    href="<%=path %>/system/detail/MemberManageDelete.do?id=${user.id }&beginDate=${beginDate}&endDate=${endDate}&userName=${userName}">删除</a>
                            </td>
                    ...
                    <tr align="center">
                        <td colspan="5">共${page.totalRecords}条记录 &nbsp;&nbsp;共
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <a
                                            href="<%=request.getContextPath()%>/system/findAllUsersByPage.do?currentpage=1&userName=${userName}&beginDate=${beginDate}&endDate=${endDate}">&nbsp;&nbsp;
                                        首页</a>
                                </c:otherwise>
                            </c:choose>
