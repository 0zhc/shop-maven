    ...
    <form action="welcom.html">
        <table class="myshop">
            ...
            <tr>
                ...
                <td style="text-align:center;"><img src="../../../shop/shop_image/selectShop/blue.jpg"
                                                    style="height:300px;"/></td>
                <td style="text-align:center;"><input type="radio" name="selectshop" checked="checked"/>选择蓝色</td>
            </tr>
            <tr style="text-align:center;">
                <td>模板二</td>
                <td><img src="../../../shop/shop_image/selectShop/red.jpg" style=" height:300px;"/></td>
                <td><input type="radio" name="selectshop"/>选择红色</td>
            </tr>
            <tr>
