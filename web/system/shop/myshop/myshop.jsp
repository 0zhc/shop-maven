    ...
    <form action="<%=path%>/system/userAddShop.do" id="addShopForm" method="post" onsubmit="return check()">
        <table class="myshop">
            <tr style="line-height:21px;">
                <td colspan="2"><a href="#">首页</a><span>>></span><a href="#">后台管理</a><span>>></span><a href="#">我的店铺</a>
                </td>
            ...
            <tr>
                ...
                <td><input type="text" name="name" id="name" onblur="checkShopName()"/>（这个比较重要，搜索店铺时，以这个为主）<span
                        id="checkName"></span></td>
            </tr>
                ...
                <c:choose>
                    <c:when test="${userNew.userType==1}">
                        <td>
                            ...
                            输入宿舍号<input type="text" name="shopDetailAddress" id="number" onblur="checkNumber()"/><span
                                id="checkNumber"></span></td>
                    </c:when>
                    <c:when test="${userNew.userType==2}">
                        ...
                        <td>
                            ...
                            输入详细地点<input type="text" name="shopDetailAddress" id="number1"
                                         onblur="checkNumber1()"/><span id="checkNumber1"></span>
                        </td>
            ...
            <tr style="border: none;">
                ...
                <td style="border: none;"><textarea rows="16" cols="81" id="content1" style="width:690px;"
                                                    name="shopInfo">
           </textarea><span id="word_count"></span><span id="checkInfo"></span></td>
            </tr>
            <tr style="text-align:center;">
                <td colspan="2"><input type="submit" value="提交" onclick="addUserShop()"/>&nbsp;&nbsp;&nbsp;<input
