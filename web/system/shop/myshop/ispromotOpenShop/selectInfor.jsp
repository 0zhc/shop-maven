...
<head>
    ...
    <script>
        ...
        function goshop() {
            ...
            } else if ($("input[name=selectInfor][checked]").val() == '2') {
        ...
        <table border="0" cellspacing="0" class="myshop">
            <tr style="line-height:21px;">
                <td colspan="3"><a href="../../../../index.html" target="_parent">首页</a><span>>></span><a
                        href="../../../manager_index.html" target="_parent">后台管理</a><span>>></span>请选择开店身份
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="text-align:center;">学生<input type="radio" checked="checked" name="selectInfor" value="1"/>
                </td>
