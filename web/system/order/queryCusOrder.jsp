                ...
                <c:forEach items="${goodsOrder}" var="goodsOrder" varStatus="status">
                    <tr>
                        ...
                        <td style="text-align:center;font-size:15px;"><a
                                href="<%=request.getContextPath()%>/order/selectOrders.do?id=${goodsOrder.id}">查看</a>
                            <c:if test="${goodsOrder.state==1 }">
                                <a href="<%=request.getContextPath()%>/order/deliverGoods.do?id=${goodsOrder.id }"
                                   onClick="return confirm('是否发货？')">发货</a>
                            </c:if>
                            <c:if test="${goodsOrder.state!=1 }">
                                已发货
                            </c:if>
                            ...
                            <c:if test="${goodsOrder.state!=2 }">
                                <a href="<%=request.getContextPath()%>/order/deleteOrder.do?id=${goodsOrder.id }"
