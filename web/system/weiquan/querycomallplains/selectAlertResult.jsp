...
<body>
<div id="content">
    <div id="navigation">当前位置：<a href="#">首页</a><span>>></span><a href="#">后台管理</a><span>>></span><a href="#">他人投诉</a>
    </div>
    <form action="<%=request.getContextPath() %>/complaint/addComplaintAlertReply.do" id="complaint" method="post"
                    ...
                    <table width="100%" border="0" cellspacing="0">
                        <tr>
                            ...
                            <td width="38%" style="text-align:center;font-size:15px;"><span
                                    style="text-align:center;">${complaintAlert.user.shop.name }</span></td>
                        ...
                        <c:forEach items="${complaintReply}" var="complaintReply" varStatus="status">
                            <tr>
                                <td style="text-align:center;font-size:15px;">
                                    <c:if test="${complaintReply.writer.id!=user.id }">${complaintReply.writer.callName }的回复</c:if>
                        ...
                        <tr>
                            <td align="center">回复内容 <br/>(100个汉字以内)</td>
                            <td colspan="3"><textarea name="replyContent" cols="21" rows="18" id="content1"
