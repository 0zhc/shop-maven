...
<body>
<div id="content">
    <div id="navigation">当前位置：<a href="#">首页</a><span>>></span><a href="#">后台管理</a><span>>></span><a
            href="#">查看所有投诉结果</a></div>
    <form action="#">
                ...
                <c:forEach items="${complaints}" var="complaints" varStatus="status">
                    <tr>
                        ...
                        <td style="text-align:center;font-size:15px;"><a
                                href="<%=request.getContextPath()%>/complaint/selectSystemComplaint.do?tradeId=${complaints.tradeRecord.id}">查看</a>
