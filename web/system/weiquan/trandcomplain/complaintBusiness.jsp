...
<div id="content">
    ...
    <form action="<%=request.getContextPath() %>/complaint/addComplaint.do" method="post" id="complaint"
          name="complaint" onsubmit="return isSubmit()">
                    ...
                    <table width="100%" border="0" cellspacing="0">
                        <tr>
                            ...
                            <td width="87%" align="left"><span
                                    style="text-align:center;">${tradeRecord.goods.shop.name }</span>
                        ...
                        <tr>
                            ...
                            <td align="left"><input type="text" style="width: 450px" name=complain id="complain"/>(20个汉字以内)
                            </td>
                        </tr>
                        <tr>
                            <td align="center">详细描述</td>
                            <td><textarea name="detailreason" cols="21" rows="18" id="content1"
