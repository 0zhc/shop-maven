            ...
            <c:forEach items="${complaintAlerts}" var="complaintAlerts" varStatus="status">
                <tr>
                    ...
                    <td style="text-align:center;font-size:15px;"><a
                            href="<%=request.getContextPath() %>/complaint/selectComplaintAlert.do?id=${complaintAlerts.id}">查看</a><a
                            href="<%=request.getContextPath() %>/complaint/deleteComplaintAlert.do?id=${complaintAlerts.id }"
