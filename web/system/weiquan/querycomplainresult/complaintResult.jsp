...
<body>
<div id="content">
    <div id="navigation">当前位置：<a href="#">首页</a><span>>></span><a href="#">后台管理</a><span>>></span><a href="#">投诉结果</a>
    </div>
    <form action="#">
                ...
                <c:forEach items="${complaints}" var="complaints" varStatus="status">
                    <tr>
                        ...
                        <td style="text-align:center;font-size:15px;"><a
                                href="<%=request.getContextPath()%>/complaint/selectComplaint.do?tradeId=${complaints.tradeRecord.id}">查看</a><a
                                href="<%=request.getContextPath()%>/complaint/deleteComplaint.do?id=${complaints.id }">删除</a>
                        </td>
                    </tr>
                </c:forEach>
                <tr>
