...
<div id="content">
    ...
    <form action="<%=request.getContextPath() %>/stationAnnouce/searchTimeSendStationAnnouces.do" method="post"
                ...
                <c:forEach items="${stationAnnouce}" var="stationAnnouce" varStatus="status">
                    <tr>
                        ...
                        <td style="text-align:center;"><a
                                href="<%=request.getContextPath() %>/stationAnnouce/selectSendStationAnnouce.do?id=${stationAnnouce.id} ">查看</a>
                        </td>
                    </tr>
                </c:forEach>
                <tr>
