...
<body>
<div id="content">
    <div id="navigation">当前位置：<a href="#">首页</a><span>>></span><a href="#">后台管理</a><span>>></span><a href="#">查看站内公告</a>
    </div>
    <form action="<%=request.getContextPath() %>/stationAnnouce/modifyStationAnnouces.do" id="annouce" method="post"
        ...
        <table class="myshop">
            <c:if test="${stationAnnouce.state==1}">
                ...
                <tr>
                    ...
                    <td><textarea rows="16" cols="81" id="content1" name="content"
                                  style="width:690px;">${stationAnnouce.content }</textarea>
                ...
                <tr style="text-align:center;">
                    <td colspan="2"><input type="submit" value="修改"/> <input type="button" value="返回"
            ...
            <c:if test="${stationAnnouce.state==2}">
                ...
                <tr style="text-align:center;">
                    <td colspan="2"><input type="button" value="返回" onclick="history.back()"/></td>
                </tr>
            </c:if>
        </table>
    </form>
