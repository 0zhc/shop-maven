...
<head>
    ...
    <title>优复用商店搜索结果</title>
    <link href="<%=path %>/css/sysytem/managerIndex.css" type="text/css" rel="stylesheet"/>
    <link href="<%=path %>/css/shopandgoods/shop.css" type="text/css" rel="stylesheet"/>
    <link href="<%=path %>/css/search/search.css" type="text/css" rel="stylesheet"/><!--引入搜索样式-->
    <link href="<%=path%>/css/comm/backg_line.css" type="text/css" rel="stylesheet"/>
    <link href="<%=path%>/css/comm/top.css" type="text/css" rel="stylesheet"/>
    <link href="<%=path%>/css/shopandgoods/searchgoods_second.css" type="text/css" rel="stylesheet"/>
    ...
    <!-- 分页查询 -->
    <script type="text/javascript">
        var shopBuyType = '${shopBuyType}';
        var name = '${name}';
        var basePath = '<%=path %>/';//根路径
        var beginDate = '2009-9-24'//$('#beginPrice').val();
        var endDate = '2015-9-24'//$('#endPrice').val();
        var isSore = 1; //默认为降序
        $(function () {
            $('#btn').click(function () {
                alert($('#hello').val());
        ...
        function query(i) {
            ...
            $
                .ajax({
                    ...
                    url: "${pageContext.request.contextPath}/search_shops_shops/searchAllShopsByName.do",
                    ...
                    success: function (msg) {
                        ...
                        for (var j in msg.shopsJson) {


                            var imgLogoUrl = basePath + msg.shopsJson[j].logoUrl;

                            if (msg.shopsJson[j].logoUrl == null) {
                                imgLogoUrl = basePath + 'images/load/grey.gif';
                            }


                            var imgLogoUrlReplaced = ReplaceAll(imgLogoUrl, "\\", "/");


                            var shopName = msg.shopsJson[j].name;
                            var description = msg.shopsJson[j].shopInfo.substring(0, 20) + "... ...";
                            var shopNameReprced = shopName
                                .replace(
                                    name,
                                    '<font color="red" style="color:#e90000; font-size:13px; font-weight:900;">' + name + '</font>');//对搜索关键字进行替换样色

                            $('table')
                                .append(
                                    '<tr><td><a  class="picImg" href="' + path + '/shop.do?id=' + msg.shopsJson[j].id + '"><img src="'
                                    + imgLogoUrlReplaced
                                    + ' "/></a></td><td style="text-align:left;padding-left:10px; line-height:20px;">店铺名:'
                                    + shopNameReprced
                                    +
                                    '<br/>介绍：'
                                    + description
                                    + '</td><td ><a id="shoper_qq" href="http://wpa.qq.com/msgrd?V=1&amp;Uin=' + msg.shopsJson[j].qq + 'amp";target="_blank">QQ联系我</a>'
                                    + '</td><td>开店地点:<font color="#006697">'
                                    + msg.shopsJson[j].shopBigAddress
                                    + msg.shopsJson[j].shopDetailAddress
                                    + '</font></td>'
                                    + '<td>开店时间：<br/>' + msg.shopsJson[j].createDate + '</td>'
                                    + '<td><a id="see_shop" href="' + path + '/shop.do?id=' + msg.shopsJson[j].id + '">进入商店看看....</a></td></tr>');
...
<div id="container" style=" width: 1200px;">
    ...
    <div id="banner" style="clear:both; height: 40px;width: 1200px;"><a href=""><img
            src="<%=path%>/images/banners/taobao.jpg" style="width: 1193px;"/></a></div>
    ...
    <div id="main" style="height:800px; border:none; padding-top:8px;">
        <div id="main_left" style="height: 800px;">
            <div id="shopIntroduct_top"></div>
            <div id="shopIntroduct_middle">
                <ul style="margin-top:-20px;">
                    <li>
                        <div style="text-align:center;"><a href="shop.do?id=1" style=""><img
                                src="<%=path %>/images/searchshopgood/introductShop/90shi.jpg"/></a></div>
                        <div class="describle"><span>90食</span></div>
                        <div class="describle"><span>主营商品：</span><span>零食、饮料</span></div>
                        <div class="describle goShop"><a href="shop.do?id=1">进入店铺看看.....</a>;</div>
                    </li>

                    <li>
                        <div style="text-align:center;"><a href="shop.do?id=3" style=""><img
                                src="<%=path %>/images/searchshopgood/introductShop/8haologo.jpg"/></a></div>
                        <div class="describle"><span>8号当铺</span></div>
                        <div class="describle"><span>主营商品：</span><span>运动鞋</span></div>
                        <div class="describle goShop"><a href="shop.do?id=3">进入店铺看看.....</a>;</div>
                    </li>

                    <li>
                        <div style="text-align:center;"><a href="shop.do?id=4" style=""><img
                                src="<%=path %>/images/searchshopgood/introductShop/DIYlogo.jpg"/></a></div>
                        <div class="describle"><span>DIY</span></div>
                        <div class="describle"><span>主营商品：</span><span>各类电脑配件</span></div>
                        <div class="describle goShop"><a href="shop.do?id=4">进入店铺看看.....</a>;</div>
                    </li>
                    <li>
                        <div style="text-align:center;"><a href="shop.do?id=5" style=""><img
                                src="<%=path %>/images/searchshopgood/introductShop/logo.jpg"/></a></div>
                        <div class="describle"><span>崇明507</span></div>
                        <div class="describle"><span>主营商品：</span><span>二手商品</span></div>
                        <div class="describle goShop"><a href="shop.do?id=5">进入店铺看看.....</a></div>
                    </li>
                </ul>
            </div>
            <div id="shopIntroduct_bottom"></div>
        </div>

        <div id="main_right" style="width: 992px;padding: 0px;margin: 0px;overflow: hidden;height: 750px;">


            <div id="search_shopIntroduct_top"><span
                    style="margin-left:25px; font-size:13px; color:#FFFFFF; font-weight:900; line-height:40px;">搜索结果如下</span>
            </div>
            <div id="search_shopIntroduct_middle" style="background-image: none;">
                <div id="show_shop_tip">
                    <img src="<%=path %>/images/searchshopgood/searchTip.jpg" style="vertical-align:middle; "/>关于<span
                        style="color:#e90000;">${name }</span>商店
                </div>
                <div id="show_shop_search" style="margin-top:10px; border-bottom:#CCCCCC dotted 1px; height:30px;">
                    <ul style="padding-left:5px;">
                        <li>共搜索到<span style="color:#e90000; font-size:13px; font-weight:900;" id="total"></span>个符合条件的店铺。
                        </li>
                        <li style="margin-left:342px; width:100px;" id="sortPrice">
                            <a href="#"
                        ...
                        <li style="margin-left:20px; line-height:24px;">时间：</li>
                        <li><input type="text" style="width:80px;" id="beginDate" value="2010-9-24" readonly="readonly"
                                   onClick="WdatePicker()"/></li>
                        <li style="line-height:24px; margin-left:10px; margin-right:10px;">到</li>
                        <li><input type="text" style="width:80px;" id="endDate" value="2015-9-24" readonly="readonly"
                                   onClick="WdatePicker()"/></li>
                        <li style="margin-left:10px;"><a href="javascript:void(0)" onclick="searchByDate(1);"><img
                                src="<%=path %>/images/searchshopgood/searchButtom.jpg" style="border:none;"/></a></li>
                    </ul>
                </div>
                <div id="showShop" style="height:400px; clear:both;">


                    <!-- test -->

                    <div id="Resuxt" style="height: 622px; width: 986px;overflow: hidden;">
                    ...
                    <div style="text-align: center;height: 50px;" id="pageAction">
                        ...
                        <span style="position: absolute; top: 0px;left: 440px;">
    ...
    <div id="footer">
        ...
        <div style="clear:both; text-align:center; margin-top:-101px; margin-left: 444px; color:#9b9b9b; font-size:12px;">&nbsp;优复用&nbsp;</div>
    </div>
