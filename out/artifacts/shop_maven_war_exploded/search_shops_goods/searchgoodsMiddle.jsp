...
<style type="text/css">
  ...
  <body  onload="remove_loading()">
   ${param.isNew}
   ${param.name}
  <iframe src="<%=path %>/search_shops_goods/searchAllGoodsByName.do?isNew=${param.isNew}&name=${param.name}"  width="100%" marginwidth="0" height="100%" marginheight="0" frameborder="0" ></iframe>
