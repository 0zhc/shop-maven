        ...
        <table  class="myshop">
         ...
         <c:choose>
          ...
          <tr>				
			  ...
			  <td style="text-align:center;font-size:14px;" >显示<input type="radio" checked="checked" name="hot" value="1"/>不显示<input type="radio" name="hot" value="2"/></td>
			  <td style="text-align:center;font-size:14px;" ><input type="button" value="修改" style="margin-right: 20px;" onclick="isHotShow();"/></td>
           ...
           <tr>				
			  ...
			  <td style="text-align:center;font-size:14px;" >显示<input type="radio" checked="checked" name="new" value="1"/>不显示<input type="radio" name="new"  value="2"/></td>
			  <td style="text-align:center;font-size:14px;" ><input type="button" value="修改" style="margin-right: 20px;" onclick="isNewShow();"/></td>
           ...
           <tr>				
			  ...
			  <td style="text-align:center;font-size:14px;" >显示<input type="radio" checked="checked" name="second" value="1" />不显示<input type="radio" name="second" value="2" /></td>
			  <td style="text-align:center;font-size:14px;" ><input type="button" value="修改" style="margin-right: 20px;" onclick="isSecondShow();"/></td>
             
              
		  </tr>
          <tr>				
			  
			  <td style="text-align:center;font-size:14px;" colspan="3" ><a href="<%=path %>/system/shop/prompt.do?Jsptype=seeUserShop" target="_top">查看修改结果</a></td>
			 
             
              
		  </tr>
          <tr><td colspan="3"><div style="position: absolute;left: 300px; top:20px;"><img src="<%=path %>/images/load/loading.gif" id="loading" style="display: none;" / ></div>
                              <div style="text-align: center;"><span id="tip" style="margin-right: 100px;"></span></div>
          </td></tr>
         
            </c:when>
            <c:otherwise>
                <tr style="text-align: center;"><td colspan="3">您还没有开店</td></tr>
            </c:otherwise>
         </c:choose>
