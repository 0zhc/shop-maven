...
<div  id="content">
     ...
     <table  class="myshop">
         ...
         <tr>
           <td  style=" padding-left:10px;width: 200px;">店铺网址<span style="color:#FF0000;">*</span></td><td><div style="float: left; line-height: 29px;"><a href="<%=path %>/shop.do?id=${user.shop.id}" target="_top">${userNew.shop.url }</a></div><div style="float: right;width:90px;height:29px; padding-left:10px; background-image: url('<%=path %>/images/seeMyshop.jpg'); background-repeat: no-repeat;line-height: 30px;margin-right: 150px;"><a href="<%=path %>/shop.do?id=${user.shop.id}" target="_top"  style="color: white;">查看店铺</a></div></td>  
         </tr>
         <tr>
           <td  style=" padding-left:10px;">店铺名称<span style="color:#FF0000;">*</span></td><td><input name="name" type="text"  value="${userNew.shop.name }" id="name" onblur="checkShopName()"/><span id="checkName"></span></td>  
         </tr>
              ...
              <c:when test="${userNew.userType==1}">
                <select name="shopBigAddress" style="width:100px;" id="shopBigAddress">
                  ...
                  <option value="同源苑">同源苑</option>
                                         ...
                                         宿舍号 <input type="text"  value="${userNew.shop.shopDetailAddress}"  name="shopDetailAddress" id="number" onblur="checkNumber()"/><span id="checkNumber"></span>
              </c:when>
              <c:otherwise>
                   <!-- 商家 -->
                 <select>
                 ...
                 <input type="text"  value="${userNew.shop.shopDetailAddress}" name="shopDetailAddress" id="number1" onblur="checkNumber1()"/><span id="checkNumber1"></span>
         ...
         <tr>
           <td style=" padding-left:10px;">店铺介绍<span style="color:#FF0000;">*</span></td><td><textarea rows="16" cols="81" id="content1"  style="width:650px;" name="shopInfo" >${userNew.shop.shopInfo}</textarea><span id="word_count"></span><span id="checkInfo"></span></td>
         </tr>
         
          <tr>
             <td colspan="2" style="text-align:center;"><img src="<%=path %>/shop/shop_image/selectShop/blue.jpg" height="150px;" style="vertical-align:middle;" />蓝色<input type="radio"  name="template" checked="checked" value="1"/>
             <img src="<%=path %>/shop/shop_image/selectShop/red.jpg" height="150px;"  style="vertical-align:middle;"/>红色<input type="radio"  name="template" value="2"/></td>
         </tr>
         ...
         <tr style="text-align:center;">
           <td colspan="2"><input type="submit" value="修改" />&nbsp;&nbsp;&nbsp;<input type="reset"  value="重置"/>&nbsp;&nbsp;&nbsp;<input type="reset"  value="返回"/></td>
         </tr>
     </table>
     </form>
</div>
