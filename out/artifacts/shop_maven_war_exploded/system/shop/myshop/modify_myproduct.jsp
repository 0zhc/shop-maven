...
<div  id="content">
     ...
     <table  class="myshop">
		 ...
		 <tr >
           <td style="padding-left:10px; padding-right:10px;">商品名称</td><td><input  name="name" type="text" value="${goods.name}" /></td>
         ...
         <tr>
            <td  style=" padding-left:10px; padding-right:10px;">商品描述</td><td><textarea rows="16" cols="81" id="content1"  style="width:690px;" name="description"></textarea></td>
           
         </tr>
         
         <tr >
           <td colspan="2" >
         <input type="submit" value="修改" /><input type="reset"  value="重置"/>&nbsp;&nbsp;<a href="../modiGoods.html">返回</a>
            </td>
