      ...
      <form action="<%=path %>/system/selectCodeActiveByPage.do">
        <table  class="myshop">
          <tr style="line-height:21px;">
            <td colspan="3" ><a href="../../../../index.html" target="_parent">首页</a><span>>></span><a href="../../../manager_index.html" target="_parent">后台管理</a><span>>></span><span style="font-size:15px;">查询商家激活码</span></td>
          </tr>
         
         <tr>
         	<td colspan="3" style="text-align:center; font-size:15px;">用户名:&nbsp;&nbsp;<input type="text" height="20" name="userName"/>&nbsp;&nbsp;&nbsp;激活码:&nbsp;&nbsp;<input type="text" height="20"  name="activeCode"/>&nbsp;&nbsp;&nbsp;<input type="submit" style="width: 50px;" value="查询" /></td>
			       ...
			       <td  style="text-align:center; font-size:15px;">
			        ...
			        <td  style="text-align:center; font-size:15px;">
                        ...
                        &nbsp; 首页 
								...
								<c:otherwise>
									<a
										href="<%=request.getContextPath()%>/system/selectCodeActiveByPage.do?currentpage=1&userName=${userName}&activeCode=${activeCode}">&nbsp;&nbsp; 首页</a>
								</c:otherwise>
							</c:choose>
