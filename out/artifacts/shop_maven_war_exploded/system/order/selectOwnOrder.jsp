...
<div id="navigation">当前位置：<a href="#">首页</a><span>>></span><a href="#">后台管理</a><span>>></span><a href="#">查看已下订单</a></div>
      <form action="<%=request.getContextPath()%>/order/takeDelivery.do?id=${goodsOrder.id }" method="post">
          ...
          <tr >
           ...
           <table width="100%" border="0" cellspacing="0">
             ...
             <tr>
               ...
               <td align="left" style="text-align:left;font-size:15px;">${goodsOrder.good.shop.user.callName }</td>
             </tr>
             <tr>
             ...
             <tr>
               ...
               <td align="left" style="text-align:left;font-size:15px;">${receiveAddress.receiverName }</td>
             </tr>
             <tr>
             ...
             <tr>
               ...
               <td align="left" style="text-align:left;font-size:15px;">${receiveAddress.shortPhone } &nbsp;</td>
             </tr>
             <tr>
             ...
             <tr>
               ...
               <c:if test="${goodsOrder.state!=3 }">
               	<input type="submit" value="已收到" onClick="return confirm('是否已收到购买物品 ?')"/>
               	</c:if>
