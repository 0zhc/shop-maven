...
<body>
<div  id="content">
<div id="navigation">当前位置：<a href="#">首页</a><span>>></span><a href="#">后台管理</a><span>>></span><a href="#">发布公告</a></div>
      <form action="#">
        <table border="0" cellspacing="0"  class="myshop">
          <tr>
			  <td  style="text-align:center;font-size:15px;">发布成功！<a href="<%=request.getContextPath() %>/stationAnnouce/searchAllStationAnnouces.do">返回</a></td>	
