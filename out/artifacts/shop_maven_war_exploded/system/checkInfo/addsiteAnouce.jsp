...
<div id="navigation">当前位置：<a href="#">首页</a><span>>></span><a href="#">后台管理</a><span>>></span><a href="#">增加公告</a></div>
      <form action="<%=request.getContextPath() %>/stationAnnouce/addStationAnnouce.do" name="annouce" id="annouce" method="post" onsubmit="return isSubmit()">
     ...
     <table  class="myshop">
         ...
         <tr>
           <td style=" padding-left:10px;">公告内容</td><td><textarea rows="16" cols="81" id="content1" name="content"  style="width:690px;" ></textarea>
         ...
         <tr style="text-align:center;">
           <td colspan="2"><input type="submit" name="add" value="增加" />&nbsp;&nbsp;&nbsp;<input type="button" value="返回" onclick="javaScript:history.back()" /></td>
         </tr>
     </table>
     </form>
</div>
