...
<div id="navigation">当前位置：<a href="#">首页</a><span>>></span><a href="#">后台管理</a><span>>></span><a href="#">投诉商家</a></div>
      <form action="<%=request.getContextPath() %>/complaint/addComplaintReply.do" id="complaint" name="complaint" method="post" onsubmit="return check()">
          ...
          <tr >
           ...
           <table width="100%" border="0" cellspacing="0">
             <tr>
               ...
               <td width="38%" style="text-align:center;font-size:15px;"><span style="text-align:center;">${complaint.user.shop.name }</span></td>
             ...
             <tr>
              ...
              <tr>
               ...
               <td colspan="3"><textarea name="replyContent" cols="21" rows="9" id="content1" style="width:100%"></textarea>
