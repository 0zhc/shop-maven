...
<body>
<div  id="content">
<div id="navigation">当前位置：<a href="#">首页</a><span>>></span><a href="#">后台管理</a><span>>></span><a href="#">警告商家</a></div>
      <form action="<%=request.getContextPath() %>/complaint/addComplaintAlert.do" method="post" id="complaintAlert" onsubmit="return isSubmit()">
          ...
          <tr >
           ...
           <table width="100%" border="0" cellspacing="0">
             <tr>
               ...
               <td width="87%" align="left"><span style="text-align:center;">${complaint.user.shop.name }</span>
             ...
             <tr>
               ...
               <td align="left"><input type="text" style="width: 450px" name="title" id="title" />(限制30字以内)</td>
             </tr>
             <tr>
               <td align="center">警告内容</td>
               <td><textarea name="alertContent" cols="21" rows="18" id="content1" style="width:100%"></textarea>
