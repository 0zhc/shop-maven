...
<body>
<div  id="content">
<div id="navigation">当前位置：<a href="#">首页</a><span>>></span><a href="#">后台管理</a><span>>></span><a href="#">投诉成功</a></div>
      <form action="#">
        <table border="0" cellspacing="0"  class="myshop">
          <tr>
			  <td  style="text-align:center;font-size:15px;">您好，感谢您的回复，我们会在24小时内给你处理，请留意们给您的回复!<a href="<%=request.getContextPath() %>/system/tradeRecord/tradPro.jsp">返回</a></td>	
