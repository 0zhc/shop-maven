...
<body>
<div  id="content">
<div id="navigation">当前位置：<a href="#">首页</a><span>>></span><a href="#">后台管理</a><span>>></span><a href="#">操作失败</a></div>
      <form action="#">
        <table border="0" cellspacing="0"  class="myshop">
          <tr>
			  <td  style="text-align:center;font-size:15px;">错误信息：<span style="color:red;">${errorInfo}请重新操作。</span><br/><a href="javaScript:history.back()">返回</a></td>	
