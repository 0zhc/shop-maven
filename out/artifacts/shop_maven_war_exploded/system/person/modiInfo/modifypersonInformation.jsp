...
<style type="text/css">
	...
	*{margin:0px; padding:0px;}	
	...
	#passwordStrength ul li{ 
		...
		color:#404040; font-family:宋体; font-size:12px; 
      ...
      <form action="<%=request.getContextPath()%>/modifyUser.do" method="post" id="myform">
        ...
        <table  class="myshop" style="width:600px;">
		  ...
		  <tr>      
				 ...
				 <td colspan="2" style="text-align:left;"><input type="text" name="callName" value="${userRe.callName}" id="callNameId" maxlength="25" onblur="validatCallName()" /><span id="callNameSpan"></span> <input type="hidden" name="id" value="${userRe.id}" /></td>      
          </tr>
          
           <tr >      
				 <td style="text-align:right; padding-right:20px; width:200px;">邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱：</td>
				 <td colspan="2" style="text-align:left;"><input type="text" name="email" value="${userRe.email}" id="emailId" maxlength="25" onblur="validateEmail()" /><span id="emailSpan"></span></td>     
          </tr>

		  <tr>      
				 <td style="text-align:right; padding-right:20px; width:200px;">输入原密码：</td>
				 <td colspan="2" style="text-align:left;"><input type="password" name="oldPassword" id="oldPasswordId" maxlength="21"/><span id="oldPasswordSpan"></span></td>      
          </tr>

          <tr >      
				 <td style="text-align:right; padding-right:20px; width:200px;">输入新密码：</td>
				 <td style="text-align:left; width:170px;"><input type="password" name="newPassword" id="newPasswordId" maxlength="21" onkeyup="pwStrength(this.value)" onblur="validateNewPassword()"/></td>
				 <td style="text-align:left;"><span id="newPasswordSpan"></span><div id="passwordStrength"><ul><li id="strength_L">弱</li><li id="strength_M">中</li><li id="strength_H">强</li></ul></div></td>     
          </tr>

           <tr >      
				 <td style="text-align:right; padding-right:20px; width:200px;">确认新密码：</td>
				 <td colspan="2" style="text-align:left;"><input type="password" name="userPassword" id="confirmPasswordId" maxlength="21" onblur="validateConPassword()" /><span id="confirmPasswordSpan"></span></td>    
          </tr>
