...
<%--                <li style="position: relative; left:-28px"><a href="javascript:void(0)" onclick="logout()" target="_top">注销</a></li>--%>
                <li style="position: relative; left:-28px"><a href="<%=request.getContextPath()%>/loginOut.do">注销</a></li>
            </c:if>
...
<%--                                    <a href="member/MembersInfo.jsp" target="mainContent">查看会--%>
    ...
    <div id="footer">
        ...
        <div class="pos" style="clear:both; text-align:center; margin-top:40px; color:#9b9b9b; font-size:12px;">优复用</div>
