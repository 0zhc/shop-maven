...
function isSubmit(){
	...
	<body>
		...
		<div id="navigation">当前位置：<a href="#">首页</a><span>>></span><a href="#">后台管理</a><span>>></span><a href="#">商品已卖</a></div>
			<form action="<%=request.getContextPath()%>/tradeRecord/searchSoleProducts.do" method="post"  name="searchForm" onsubmit="return isSubmit()">
				<table class="myshop">
