...
<body>
  ...
  <a href="javascript:void(0)" title="scope" onclick="ShowScope()" class="modifytip" style="display:none;  position:absolute; left:730px; top:10px;">修改</a>
  ...
  <div style="background-image:url(<%=request.getContextPath()%>/shop/shop_image/goodsdescripTipbottom.jpg); background-repeat:no-repeat; background-size: 922px; width:915px; height:19px;"></div>
   ...
   <div style=" height:420px;  background-color:none; position:absolute; left:430px; top:140px; z-index:500; display:none; " id="show" >
          <div id="modify">
            <div id="modify_left"></div>
            <div id="modify_middle"><div  id="showTip" style="height:33px; line-height:33px;">
             装修店铺对话框
            <a href="#" id="close"><img src="<%=request.getContextPath()%>/shop/shop_image/shopModifyShow/close_modify.jpg" alt="关闭装修店铺对话框"  onClick="return false"/></a></div>
