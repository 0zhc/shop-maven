  ...
  <body>
   <div  id="content"  style="padding-left: 30px;padding-top: 3px;">
     ...
     <table  class="myshop" cellspacing="0" style="100%px;">
         ...
         <div id="add">
             <!--以下是预览图片用的-->
                 ...
                 <img id="preview_size_fake"  src="<%=path %>/cutpicture/imgs/show.gif"/><!-- Ie -->
                   ...
                   <div>(<span style="color: red; font-size: 12px;">注</span>:长度777px和高度234px,大小不要超过200KB,只能使用gif,jpg格式)</div>
        ...
        <input type="button" value="上传图片" onclick="ajaxFileUpload(add)" style="width: 60px; margin-left: 50px;"/><img src="<%=path %>/cutpicture/imgs/loading.gif" id="loading" style="display:none;position: absolute;"/>
       <br/> <a href="<%=path %>/shop/selectRollingGoods.do?shopId=${user.shop.id }&typeJsp=selecRollingGoods" style="float: right;margin-right: 40px;color: blue;">返回查询页面</a>
