   ...
   <div  id="content"  style="width:995px;margin-left: 15px;">
     ...
     <table  class="myshop" cellspacing="0" style="width: 100%;">
         ...
         <div id="add">
             <!--以下是预览图片用的-->
                 ...
                 <img id="preview" src="<%=path %>/cutpicture/imgs/show.gif" onload="onPreviewLoad(this)" /><!-- firefox -->
                   ...
                   <div style="color: purple;margin-top: 15px;font-size: 14px;margin-bottom: 15px;">(<span style="color: red; font-size: 15px;">注</span>:长度777px和高度234px,大小不要超过200KB,只能使用gif,jpg格式)</div>
        ...
        <input type="button" value="修改图片" onclick="ajaxFileUpload(add)" style="width: 60px; margin-left: 50px;"/><img src="<%=path %>/cutpicture/imgs/loading.gif" id="loading" style="display:none;position: absolute;"/>
         ...
         <tr style="text-align: center;"><td colspan="5"> <div style="text-align: right;"><input type="button" value="取消" onclick="javascript:history.back()"  style="margin-right: 130px;"/></div></td></tr>
