                ...
                <table border="0" cellspacing="0" width="100%">
                  <tr>				
                   ...
                   <c:forEach items="${secondGoods}" var="secondGood">
						...
						<td  style="text-align:center;"><img src="<%=path %>/${secondGood.url}" width="177px" height="118px" /></td>
            			...
            			<td align="center" >                        
                        	<a href="<%=path %>/system/shop/myshop/goodsDetail.do?JspType=secondDatail&goodsId=${secondGood.id}">详情</a>&nbsp; <a href="<%=path %>/system/shop/myshop/goodsDetail.do?JspType=secondModifyDatail&goodsId=${secondGood.id}">修改</a>&nbsp;<a href="<%=path %>/shop/rollingGoods/delete.do?goodsId=${secondGood.id}&userId=${user.id}&userName=${user.userName}&shopId=${user.shop.id}&deleteType=deleteSecondgoods">删除</a>
                        </td>
          		        </tr>
                   </c:forEach>
                 <c:if test="${count<4}">
                   <tr>
                	<td id="input" colspan="6" style="text-align: center;"><a href="<%=path%>/shop/shopModify/productModify/addSecondProduct.jsp" style="font-size: 18px;">---->>>添加</a></td>
