...
<style type="text/css">
  ...
  <body  onload="remove_loading()">
   <iframe src="<%=path %>/shop/selectRollingGoods.do?shopId=${user.shop.id }&typeJsp=selecRollingGoods"  width="100%" marginwidth="0" height="100%" marginheight="0" frameborder="0" ></iframe>
