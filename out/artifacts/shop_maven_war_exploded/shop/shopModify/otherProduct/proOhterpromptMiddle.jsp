...
<style type="text/css">
  ...
  <body  onload="remove_loading()">
   <iframe src="<%=path %>/system/selectUserGoodsByPage.do?jspType=otherGoods&goodsType=4&name="  width="100%" marginwidth="0" height="100%" marginheight="0" frameborder="0" ></iframe>
