...
<style type="text/css">
	*{margin: 0px; padding: 0px; }
	...
	#if_add{ width:600px; margin-top:15px; margin-left:50px; font-family:宋体; font-size:14px; color:#424242; }
	#addComplete{width:600px; margin-left:50px; }
	#addComplete div{ margin-top:15px; font-family:宋体; font-size:14px; color:#424242; }
	#modifyNewSuccess,#addAnnouceSuccess{height:30px; margin-top:15px; margin-left:20px; font-family:宋体; font-size:14px; color:#FF7D7D;}
	
		
	#addDecorate,#updateDecorate{ margin-left:120px;}
	.new{ width:190px; color:#2D2D2D;}
	#if_add{ padding-left:12px;}
	#if_add a{ text-decoration:none; color:#969696;}
	#if_add a:hover{color:#424242;}
	.new_condition{ color: #CC0000; display:none;}
...
<form id="regForm">
		<fieldset>
			<legend>店铺公告</legend>
            <div id="if_add"><span>你还没有添加店铺公告信息&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><a id="add" href="#">马上添加</a></div>
			<div id="addComplete">
				<div>
					<label  >最新动态一：<span style="color: red;">*</span></label>
					<input class="new" id="newOneId" type="text" name="newOne" maxlength="45" value="${shopAnnouceList[0].content}" onBlur="validatNewOne()" />&nbsp;<span class="new_condition">第一条店铺公告不能为空，并且为16-30个字符</span><span id="newOneSpan"></span>
				</div>
                <div>
					<label >最新动态二：&nbsp;</label>
					<input class="new" id="newTwoId" type="text" name="newTwo" maxlength="45" value="${shopAnnouceList[1].content}" onBlur="validatNewTwo()"/>&nbsp;<span class="new_condition">请输入16-30个字符</span><span id="newTwoSpan"></span>
				</div>
                <div>
					<label >最新动态三：&nbsp;</label>
					<input class="new" id="newThreeId" type="text" name="newThree" maxlength="45" value="${shopAnnouceList[2].content}" onBlur="validatNewThree()" />&nbsp;<span class="new_condition">请输入16-30个字符</span><span id="newThreeSpan"></span>
				</div>
                <div>
					<label >最新动态四：&nbsp;</label>
					<input class="new" id="newFourId" type="text" name="newFour" maxlength="45" value="${shopAnnouceList[3].content}" onBlur="validatNewFour()" />&nbsp;<span class="new_condition">请输入16-30个字符</span><span id="newFourSpan"></span>
				</div>
                <div>
