   ...
   $(function(){
	...
	<style type="text/css">
		*{margin: 0px; padding: 0px; }
		#modify_businfo{margin-top:20px; margin-left:33px;}
		#if_add{ width:450px; margin-top:15px; margin-left:80px; font-family:宋体; font-size:14px; color:#424242; }
		#addComplete{width:450px; margin-left:80px; }
		#addComplete div{ margin-top:15px; font-family:宋体; font-size:14px; color:#424242; }
		#modifyUserInfoSuccess{height:30px; margin-top:15px; margin-left:50px; font-family:宋体; font-size:14px; color:#FF7D7D;}
		
		#decorate{ margin-left:100px;}
		#if_add a{ text-decoration:none; color:#969696;}
		#if_add a:hover{color:#424242;}
		label span{ color:red;}
		.busifo_condition{ color: #CC0000; display:none;}
...
<div id="modify_businfo">
	<form action="<%=request.getContextPath()%>/modifyUserInfo.do?userId=${userId}" method="post" id="regForm" onSubmit="return validateForm()">
		<fieldset>
			<legend>店主信息</legend>
            <div id="if_add"><span>你还没有添加店主信息&nbsp;&nbsp;&nbsp;&nbsp;</span><a id="add" href="javascript:void(0)">马上添加</a></div>
			<div id="addComplete">
				<div>
					<label>昵&nbsp;称：<span>*</span>&nbsp;</label>
					<input class="busifo" id="callNameId" type="text" name="callName" value="${userRequest.callName}" onBlur="validatCallName()" />&nbsp;<span class="busifo_condition">1-10个字符，一个汉字为两个字符</span><span id="callNameSpan"></span>
					<input type="hidden" name="id" value="${userRequest.id }"/> 
				</div>
                <div>
					<label>长&nbsp;号：<span>*</span>&nbsp;</label>
					<input class="busifo" id="telephoneId" type="text" name="telephone" value="${userRequest.telephone}" onBlur="validatTelephone()" />&nbsp;<span class="busifo_condition">请填写真实手机号码</span><span id="telephoneSpan"></span>
				</div>
                <div>
					<label>短&nbsp;号：&nbsp;&nbsp;</label>
					<input class="busifo" id="shortNumberId" type="text" name="shortNumber" value="${userRequest.shortNumber}" onBlur="validatShortNumber()"  />&nbsp;<span class="busifo_condition">请填写真实短号</span><span id="shortNumberSpan"></span>
				</div>
                <div>
					<label>Q&nbsp;&nbsp;&nbsp;Q：<span>*</span>&nbsp;</label>
					<input class="busifo" id="qqId" type="text"  name="qq" value="${userRequest.qq}" onBlur="validatQQ()" />&nbsp;<span class="busifo_condition">请填写真实QQ号码</span><span id="QQSpan"></span>
				</div>
                <div>
