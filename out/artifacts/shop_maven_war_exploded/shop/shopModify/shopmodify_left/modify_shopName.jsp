   ...
   $(function(){
	...
	<style type="text/css">
		*{margin: 0px; padding: 0px;}
		...
		#if_add{ width:450px; margin-top:15px; margin-left:60px; font-family:宋体; font-size:14px; color:#424242; }
		#addComplete{width:450px; margin-left:60px; }
		#addComplete div{ margin-top:15px; font-family:宋体; font-size:14px; color:#424242; }
		#modifyShopNameSuccess{height:30px; margin-top:15px; margin-left:20px; font-family:宋体; font-size:14px; color:#FF7D7D;}
		
		#decorate{ margin-left:110px;}
...
<div id="modify_businfo">
	<form action="<%=request.getContextPath()%>/modifyShopName.do?userId=${userId}" method="post" id="regForm" onSubmit="return validateForm();">
		<fieldset>
			<legend>店铺名称</legend>
            <div id="if_add"><span>你还没有添加店铺名称&nbsp;&nbsp;&nbsp;&nbsp;</span><a id="add" href="javascript:void(0)">马上添加</a></div>
			<div id="addComplete">
				<div>
					<label>店名：<span>*</span>&nbsp;</label>
					<input class="busifo" id="shopNameId" type="text" name="shopName" value="${shop.name}" onBlur="validatshopName()" />&nbsp;<span class="busifo_condition">1-12个字符，一个汉字为两个字符</span><span id="shopNameSpan"></span>
