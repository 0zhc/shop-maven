          ...
          function ajaxFileUpload(){
           ...
           .ajaxComplete(function(){
            $(this).hide();
               ...
               $.ajaxFileUpload(
                   {
      url:'<%=path %>/fileupload/addbanner.do?x1='+x1+'&y1='+y1+'&w='+w+'&h='+h+'&userName='+userName+'&shopId='+shopId+'&goodsType='+goodsType,            //需要链接到服务器地址
                secureuri:false,
                  type: "post",
  ...
  <body>
   <div  id="content"  style="padding-left: 30px;padding-top: 3px;">
     ...
     <table  class="myshop" cellspacing="0" style="100%px;">
         <tr>
           <th colspan="5" >店铺<span>>></span>店铺装修<span>>></span>添加bannner商品</th>
         ...
         <div id="add">
             <!--以下是预览图片用的-->
                 ...
                 <img id="preview" src="<%=path %>/cutpicture/imgs/show.gif" onload="onPreviewLoad(this)" /><!-- firefox -->
                   ...
                   <div>(<span style="color: red; font-size: 12px;">注</span>:长度890px和高度为88px，大小不要超过200KB，只能使用gif,jpg格式)</div>
        ...
        <input type="button" value="上传图片" onclick="ajaxFileUpload(add)" style="width: 60px; margin-left: 50px;" id="uplaodbuttom"/><img src="<%=path %>/cutpicture/imgs/loading.gif" id="loading" style="display:none;position: absolute;"/>
