...
<style type="text/css">
	...
	*{margin: 0px; padding: 0px; }
	...
	#modifyContactUsSuccess{height:40px; line-height:40px; font-family:宋体; font-size:14px; color:#FF7D7D;}
	-->
</style>
...
<center>
	...
	<form action="<%=request.getContextPath()%>/modifySContactUs.do?userId=${userId}" id="myForm" method="post">
		...
		<div id="ContactUsContent">
			<textarea name="content" cols="21" rows="10" id="content1" style="width:100%">${shop.contactUs}</textarea>
