...
<legend>购买产品->确认订单</legend>
  ...
  <tr>
    ...
    <td width="69%" align="left">${receiveAddress.receiverName }<input type="hidden" name="receiverName" value="${receiveAddress.receiverName }"/></td>
  </tr>
  <tr>
    <td align="right" bgcolor="#F7F7F7">联系电话：</td>
    <td align="left">${receiveAddress.phone }<input type="hidden" name="phone" value="${receiveAddress.phone }"/></td>
  </tr>
  <tr>
    <td align="right" bgcolor="#F7F7F7">短号：</td>
    <td align="left">${receiveAddress.shortPhone }&nbsp;<input type="hidden" name="shortPhone" value="${receiveAddress.shortPhone }"/></td>
  </tr>
  <tr>
    <td align="right" bgcolor="#F7F7F7">送货地址：</td>
    <td align="left">${receiveAddress.address }<input type="hidden" name="address" value="${receiveAddress.address }"/></td>
  </tr>
  <tr>
    <td colspan="2" align="center"><input type="submit" name="button" id="button" value="确认提交" onClick="return confirm('确认提交吗？')" /><input type="button" value="返回修改" onclick="javaScript:history.back()" /></td>
    </tr>
</table>
